...
var _controllersSearch = require('../controllers/search');

var _controllersSearch2 = _interopRequireDefault(_controllersSearch);
...
angular.module('searchApp', []).service('MessagingService', _servicesMessagingService2['default']).directive('ngCategories', _directivesNgCategories2['default']).controller('SearchController', _controllersSearch2['default']);

},{"../controllers/search":4,"../directives/ngCategories":5,"../services/MessagingService":6}],4:[function(require,module,exports){
/**
