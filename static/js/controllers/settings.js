...
angular.module('settingsApp', []).service('MessagingService', _MessagingService2['default']).controller('SettingsController', _SettingsController2['default']);
/**
...
},{"../controllers/SettingsController":4,"../services/MessagingService":5}],2:[function(require,module,exports){
/*!
  ...
  _createClass(SettingsController, [{
    ...
    value: function pullGroupData() {
      ...
      this.$http.get('/app/settings/data').success(function (response) {
        _this.groupMembers = response.data.group_members;
        _this.userEmail = response.data.group_to_answer;
        _this.groupMaster = response.data.group_master;
      }).error(function (err) {
        return _this.MessagingService.danger(err);
      });
    }
  }, {
    key: 'addToUserGroup',
    ...
    value: function apiRequest(action, data) {
      var _this2 = this;
	  _this2.loading = true;
      var url = arguments[2] === undefined ? '/app/settings' : arguments[2];
      data.action = action;
      this.$http({
        method: 'POST',
        url: url,
        ...
        _this2.MessagingService.danger(err);
      });
    }
  }, {
    key: 'changePassword',
    ...
    value: function leaveUserGroup() {
	  ...
	  if (this.userGroup.name.trim()) {
        ...
        this.MessagingService.danger('No groupname defined');
      }
	}
  }, {
...
// TODO: need to get this member's email
