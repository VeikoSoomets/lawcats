...
var _QuerywordsController = require('../controllers/querywords');

var _QuerywordsController2 = _interopRequireDefault(_QuerywordsController);
...
// Setup angular app
angular.module('querywordsApp', []).service('MessagingService', _MessagingService2['default']).directive('ngCategories', _ngCategories2['default']).controller('QuerywordsController', _QuerywordsController2['default']);

},{"../controllers/querywords":4,"../directives/ngCategories":5,"../services/MessagingService":6}],2:[function(require,module,exports){
/*!
...
var QuerywordsController = (function () {
  function QuerywordsController(MessagingService, $http) {
    _classCallCheck(this, QuerywordsController);
  ...
  _createClass(QuerywordsController, [{
    key: 'pullCategories',

    /**
     * Get categories.
     */
    value: function pullCategories() {
      var _this = this;
      ...
      this.$http({
        ...
        data.sources.forEach(function (mainCategory) {
          mainCategory[1].forEach(function (subCategory) {
            subCategory[1].forEach(function (category) {
              _this.newQueryword.sources.push({
                checked: false,
        ...
        _this.querywords = data.querywords;
        _this.loaded = true;
      });
    }
  }, {
     ...
     */
    value: function removeQueryword(queryword) {
      var querywordIndex = this.querywords.indexOf(queryword);
     ...
     */
    value: function createQueryword() {
      var _this2 = this;

      var sources = [];

      // Get the sources
      this.newQueryword.sources.forEach(function (source) {
        if (source.checked) {
      ...
      if (this.newQueryword.queryword.length > 0) {
        this.newQueryword.queryword.split(',').forEach(function (queryword) {
          if (queryword[0] === ' ') {
            queryword = queryword.replace(' ', '');
          }

          _this2.querywords.unshift({
            queryword: queryword,
            categories: sources,
            request_frequency: _this2.newQueryword.frequency * 60,
    ...
    value: function removeSource(source) {
      var querywordIndex = this.querywords.indexOf(this.modalQueryword);
      var queryword = this.querywords[querywordIndex];
     ...
     */
    value: function openModal(queryword) {
  ...
  return QuerywordsController;
})();

// Dependency injection
QuerywordsController.$inject = ['MessagingService', '$http'];

exports['default'] = QuerywordsController;
